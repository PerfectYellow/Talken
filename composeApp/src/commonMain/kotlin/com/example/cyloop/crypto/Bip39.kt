...
object Bip39 {
    ...
    fun validateMnemonic(mnemonic: String): Boolean {
        ...
        try {
            val bits = words.map { word ->
                val index = BIP39_WORDLIST.indexOf(word)
    ...
    fun generateSeed(mnemonic: String, passphrase: String = ""): ByteArray {
        ...
        // Standard BIP-39 uses 2048 iterations of HMAC-SHA512 and 512 bits output
    ...
    val BIP39_WORDLIST = listOf(
        ...
        "pilot", "pink", "pioneer", "pipe", "pistol", "pitch", "pixel", "place", "planet", "plastic",
